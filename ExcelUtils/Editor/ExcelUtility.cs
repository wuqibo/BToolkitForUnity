...
namespace BToolkit
{
    public class ExcelUtility
    {
        ...
        public void ConvertToJson(string JsonPath, Encoding encoding)
        {
            ...
            {
                using (System.IO.TextWriter textWriter = new StreamWriter(fileStream, encoding))
                {
        ...
        public void ConvertToXml(string XmlFile)
        {
            ...
            {
                using (System.IO.TextWriter textWriter = new StreamWriter(fileStream, Encoding.GetEncoding("utf-8")))
                {
                    textWriter.Write(stringBuilder.ToString());
                }
            }
